pipeline{
	...
	stages{
		...
		stage('Deploy to Kube'){
			...
			sh 'sudo /home/ec2-user/google-cloud-sdk/bin/gcloud beta auth activate-service-account jenkins@agisit0.iam.gserviceaccount.com --key-file=/home/ec2-user/agisit0-044fdfc139a2.json --project=agisit0 --verbosity=debug --quiet'
